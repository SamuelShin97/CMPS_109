...
class inode_state {
   ...
   public:
      ...
      const string& prompt();
      inode_ptr get_cwd();
      inode_ptr parse_path(const string& pathname, const string& fn);
      string get_last(const string& pathname);
...
class directory: public base_file {
   ...
   public:
      ...
      inode_ptr find_file(const string& filename);
      string find_key(const inode_ptr ptr);
      void print_map();
      void print_dirs();
};
